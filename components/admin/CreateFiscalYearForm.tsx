...
import { createFiscalYearSchema, type CreateFiscalYearInput } from '@/lib/validations/fiscal-year'
import { createFiscalYear } from '@/app/actions/fiscal-years'
...
export function CreateFiscalYearForm({ hasActiveFiscalYear = false }: CreateFiscalYearFormProps) {
  ...
  const onSubmit = async (data: CreateFiscalYearInput) => {
    ...
    try {
      const result = await createFiscalYear(data)
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex items-center gap-3 border-t border-gray-200 pt-6">
        <Button type="submit" disabled={isSubmitting}>
          {isSubmitting ? 'Creating Fiscal Year...' : 'Create Fiscal Year'}
        </Button>
