...
import { CategoryDashboardContent } from '@/components/finance/CategoryDashboardContent'
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-gray-200 bg-white px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Budget Category Analysis</h1>
            <p className="mt-1 text-sm text-gray-600">
              Analyze budget distribution across spending categories
            </p>
          </div>
        </div>
      </div>
