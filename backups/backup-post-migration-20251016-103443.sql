...
COMMENT ON COLUMN "public"."initiative_budgets"."source_name" IS 'Name of the funding source for reporting and aggregation';
...
COMMENT ON COLUMN "public"."strategic_goals"."display_order" IS 'Display order for sorting goals in the UI';
...
CREATE INDEX "initiative_budgets_source_name_idx" ON "public"."initiative_budgets" USING "btree" ("source_name");
